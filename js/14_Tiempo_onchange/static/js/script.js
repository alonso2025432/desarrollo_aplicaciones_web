...
function cambiar(){
    const medida = document.getElementById("select").value;
    ...
    const gradosf = (grados *1.8)+32;
    const gradosf1 = (grados1 *1.8)+32;
    const gradosf2 = (grados2 *1.8)+32;
    const gradosf3 = (grados3 *1.8)+32;
    const gradosf4 = (grados4 *1.8)+32;
    const gradosf5 = (grados5 *1.8)+32;
    const gradosf6 = (grados6 *1.8)+32;
    const gradosf7 = (grados7 *1.8)+32;
